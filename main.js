var btn = document.querySelector('.btn'),
    ...
    sell_love = document.querySelector('.sell_love'),
    ...
    month_love = document.querySelector('.month_love'),
    ...
    six_love = document.querySelector('.six_love'),
...
btn.onclick = function() {
    all.value = +btn.value + +parents.value + +parents_int.value + +start.value + +love.value + +optimum.value + +choice.value + +komfort.value + +bezlim.value + +region.value
    ...
    sell_love.value = +love.value *100
    ...
    sell_all.value = +sell_par.value + +sell_par_int.value + +sell_love.value + +sell_start.value + +sell_choice.value + +sell_optimum.value + +sell_komfort.value + +sell_bezlim.value + +sell_region.value
    ...
    month_love.value = +love.value * 33.75
    ...
    month_all.value = +month_par.value + +month_par_int.value + +month_love.value  + +month_love.value + +month_start.value + +month_choice.value + +month_optimum.value + +month_komfort.value
    ...
    six_love.value = +month_love.value * 5
    ...
    six_all.value = +six_par.value + +six_love.value + +six_par_int.value + +six_start.value + +six_choice.value + +six_optimum.value + +six_komfort.value + +six_bezlim.value + +six_region.value
