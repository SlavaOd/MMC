var btn = document.querySelector('.btn'),
    ...
    sell_region = document.querySelector('.sell_region'),
    ...
    month_region = document.querySelector('.month_region'),
    ...
    six_region = document.querySelector('.six_region'),
...
btn.onclick = function() {
    all.value = +btn.value + +parents.value + +parents_int.value + +start.value + +optimum.value + +choice.value + +komfort.value + +bezlim.value + +region.value
    sell_par.value = +parents.value *75
    sell_par_int.value = +parents_int.value *75
    sell_region.value = +region.value *100
    ...
    sell_all.value = +sell_par.value + +sell_par_int.value + +sell_start.value + +sell_choice.value + +sell_optimum.value + +sell_komfort.value + +sell_bezlim.value + +sell_region.value
    month_par.value = +parents.value * 18.75 
    month_par_int.value = +parents_int.value * 18.75 
    month_region.value = +region.value * 31.25
    ...
    six_region.value = +month_region.value * 5
    ...
    six_all.value = +six_par.value + +six_par_int.value + +six_start.value + +six_choice.value + +six_optimum.value + +six_komfort.value + +six_bezlim.value + +six_region.value
